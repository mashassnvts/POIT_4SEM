...
insert into TEACHER(TEACHER, TEACHER_NAME, GENDER, PULPIT) values('СКИ', 'Сосновец Мария Игоревна', 'ж', 'ПОИТ');
...
go
----------------------------------------------------------------------------------------DELETE test
delete TEACHER where TEACHER in('СКИ');
...
go
----------------------------------------------------------------------------------------UPDATE test
update TEACHER set PULPIT = 'ПОИТ' where TEACHER in('СКИ');
...
insert into TEACHER(TEACHER, TEACHER_NAME, GENDER, PULPIT) values('СМИ2', 'Сосновец2 Мария2 Игоревна2', 'ж', 'ПОИТ');
update TEACHER set PULPIT = 'ПОИТ' where TEACHER in('СМИ2');
delete from TEACHER where TEACHER in('СМИ2');
...
go
----------------------------------------------------------------------------------------INSERT test
insert into TEACHER(TEACHER, TEACHER_NAME, GENDER, PULPIT) values('СМИ', 'Сосновец Мария Игоревна', 'ж', 'ПОИТ');					--если в бд уже есть, то выполнение оператора не допускается (как и выполнение триггера)
	--delete TEACHER where TEACHER in('СМИ');
select * from TR_AUDIT
...
insert into TEACHER values ('ЫЫЫ', 'ПППП ППППП ППППП', 'м', 'ИСиТ')
insert into TEACHER values ('ЕЕЕ', 'ЛЛЛЛЛ ЛЛЛЛЛЛ ЛЛЛЛЛ', 'м', 'ИСиТ')
insert into TEACHER values ('ЙОУ', 'УУУУУ УУУУУ УУУУУУУУУУ', 'м', 'ИСиТ')

delete from TEACHER where TEACHER = 'ЫЫЫ'
delete from TEACHER where TEACHER = 'ЕЕЕ'
delete from TEACHER where TEACHER = 'ЙОУ'
...
values('ИВВ', 'Иванов Иван Иванович', 'м', 'ИСиТ');
