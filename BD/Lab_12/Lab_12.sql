...
BEGIN TRY
BEGIN TRAN                
INSERT FACULTY VALUES ('ÄÔ', 'ÔÀÊÓËÜÒÅÒ ÄÐÓÃÈÕ ÍÀÓÊ');
...
--Ñöåíàðèé A äîëæåí äåìîí-ñòðèðîâàòü, ÷òî óðîâåíü READ UNCOMMITED äîïóñêàåò íå-ïîäòâåðæäåííîå, íåïîâòîðÿþ-ùååñÿ è ôàíòîìíîå ÷òåíèå. 
-----A------
...
-------t2---------
-----------------------5----------------------
--Ñöåíàðèé A äîëæåí äåìîí-ñòðèðîâàòü, ÷òî óðîâåíü READ COMMITED íå äîïóñêàåò íå-ïîäòâåðæäåííîãî ÷òåíèÿ, 
--íî ïðè ýòîì âîçìîæíî íåïîâòîðÿ-þùååñÿ è ôàíòîìíîå ÷òåíèå. 
-- A ---
...
-------------------------- T2 -----------------
SELECT COUNT(*) FROM SUBJECT WHERE SUBJECT = 'ÈÑÈÒ';
delete FROM SUBJECT WHERE SUBJECT = 'ÈÑÈÒ';
COMMIT TRAN;
rollback
-----------------------7-----------------------
